...
export const AUTHORIZED_LOCATION: AuthorizedLocation = {
  latitude: 12.933382651731844, // San Francisco coordinates (replace with actual office location)
  longitude: 77.70289831523786,
  radius: 2000, // 100 meters radius
...
export async function requestLocationPermission(): Promise<boolean> {
  if (Platform.OS === 'web') {
    return true; // Web permissions handled differently
  }
